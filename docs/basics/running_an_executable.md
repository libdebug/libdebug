...
| `match_recvuntil` | Receives data from stdout until one of the specified patterns is matched.<br><br>**Parameters**:<br>- `patterns` (list[bytes])<br>- `drop` (bool) &nbsp;&nbsp;&nbsp; \[default = False\]<br>- `timeout` (int) &nbsp;&nbsp;&nbsp; \[default = timeout_default\]<br>- `optional` (bool) &nbsp;&nbsp;&nbsp; \[default = False\]<br><br>**Returns**:<br>- `tuple[int, bytes]`: Index of the matched pattern and the received data. |
| `match_recverruntil` | Receives data from stderr until one of the specified patterns is matched.<br><br>**Parameters**:<br>- `patterns` (list[bytes])<br>- `drop` (bool) &nbsp;&nbsp;&nbsp; \[default = False\]<br>- `timeout` (int) &nbsp;&nbsp;&nbsp; \[default = timeout_default\]<br>- `optional` (bool) &nbsp;&nbsp;&nbsp; \[default = False\]<br><br>**Returns**:<br>- `tuple[int, bytes]`: Index of the matched pattern and the received data. |
