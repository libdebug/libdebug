...
class BasicTest(unittest.TestCase):
    ...
    def test_register_find(self):
        ...
        self.assertIn("rax", d.regs.find(0x0011223344556677))
        self.assertIn("rbx", d.regs.find(0x1122334455667700))
        self.assertIn("rcx", d.regs.find(0x2233445566770011))
        self.assertIn("rdx", d.regs.find(0x3344556677001122))
        self.assertIn("rsi", d.regs.find(0x4455667700112233))
        self.assertIn("rdi", d.regs.find(0x5566770011223344))
        self.assertIn("rbp", d.regs.find(0x6677001122334455))
        self.assertIn("r8", d.regs.find(0xAABBCCDD11223344))
        self.assertIn("r9", d.regs.find(0xBBCCDD11223344AA))
        self.assertIn("r10", d.regs.find(0xCCDD11223344AABB))
        self.assertIn("r11", d.regs.find(0xDD11223344AABBCC))
        self.assertIn("r12", d.regs.find(0x11223344AABBCCDD))
        self.assertIn("r13", d.regs.find(0x223344AABBCCDD11))
        self.assertIn("r14", d.regs.find(0x3344AABBCCDD1122))
        self.assertIn("r15", d.regs.find(0x44AABBCCDD112233))
        
        d.cont()
        self.assertTrue(bp4.address == d.regs.rip)
        
        self.assertIn("al", d.regs.find(0x11))
        self.assertIn("bl", d.regs.find(0x22))
        self.assertIn("cl", d.regs.find(0x33))
        self.assertIn("dl", d.regs.find(0x44))
        self.assertIn("sil", d.regs.find(0x55))
        self.assertIn("dil", d.regs.find(0x66))
        self.assertIn("bpl", d.regs.find(0x77))
        self.assertIn("r8b", d.regs.find(0x88))
        self.assertIn("r9b", d.regs.find(0x99))
        self.assertIn("r10b", d.regs.find(0xAA))
        self.assertIn("r11b", d.regs.find(0xBB))
        self.assertIn("r12b", d.regs.find(0xCC))
        self.assertIn("r13b", d.regs.find(0xDD))
        self.assertIn("r14b", d.regs.find(0xEE))
        self.assertIn("r15b", d.regs.find(0xFF))

        d.cont()
        self.assertTrue(bp3.address == d.regs.rip)
        
        self.assertIn("ax", d.regs.find(0x1122))
        self.assertIn("bx", d.regs.find(0x2233))
        self.assertIn("cx", d.regs.find(0x3344))
        self.assertIn("dx", d.regs.find(0x4455))
        self.assertIn("si", d.regs.find(0x5566))
        self.assertIn("di", d.regs.find(0x6677))
        self.assertIn("bp", d.regs.find(0x7788))
        self.assertIn("r8w", d.regs.find(0x8899))
        self.assertIn("r9w", d.regs.find(0x99AA))
        self.assertIn("r10w", d.regs.find(0xAABB))
        self.assertIn("r11w", d.regs.find(0xBBCC))
        self.assertIn("r12w", d.regs.find(0xCCDD))
        self.assertIn("r13w", d.regs.find(0xDDEE))
        self.assertIn("r14w", d.regs.find(0xEEFF))
        self.assertIn("r15w", d.regs.find(0xFF00))

        d.cont()
        self.assertTrue(bp2.address == d.regs.rip)
        
        self.assertIn("eax", d.regs.find(0x11223344))
        self.assertIn("ebx", d.regs.find(0x22334455))
        self.assertIn("ecx", d.regs.find(0x33445566))
        self.assertIn("edx", d.regs.find(0x44556677))
        self.assertIn("esi", d.regs.find(0x55667788))
        self.assertIn("edi", d.regs.find(0x66778899))
        self.assertIn("ebp", d.regs.find(0x778899AA))
        self.assertIn("r8d", d.regs.find(0x8899AABB))
        self.assertIn("r9d", d.regs.find(0x99AABBCC))
        self.assertIn("r10d", d.regs.find(0xAABBCCDD))
        self.assertIn("r11d", d.regs.find(0xBBCCDD11))
        self.assertIn("r12d", d.regs.find(0xCCDD1122))
        self.assertIn("r13d", d.regs.find(0xDD112233))
        self.assertIn("r14d", d.regs.find(0x11223344))
        self.assertIn("r15d", d.regs.find(0x22334455))
        

        d.cont()
        self.assertTrue(bp5.address == d.regs.rip)
        
        self.assertIn("ah", d.regs.find(0x11))
        self.assertIn("bh", d.regs.find(0x22))
        self.assertIn("ch", d.regs.find(0x33))
        self.assertIn("dh", d.regs.find(0x44))
