...
def fast_suite():
    ...
    suite.addTest(TestLoader().loadTestsFromTestCase(scripts.SymbolBackendTest))
    suite.addTest(TestLoader().loadTestsFromTestCase(scripts.SymbolBackendPLTGOTTest))
    suite.addTest(TestLoader().loadTestsFromTestCase(scripts.SymbolVersioningTest))
    suite.addTest(TestLoader().loadTestsFromTestCase(scripts.SymbolEnumTest))
    suite.addTest(TestLoader().loadTestsFromTestCase(scripts.SymbolListEnhancementsTest))
    suite.addTest(TestLoader().loadTestsFromTestCase(scripts.SymbolBackwardCompatibilityTest))
    suite.addTest(TestLoader().loadTestsFromTestCase(scripts.ThreadTest))
    suite.addTest(TestLoader().loadTestsFromTestCase(scripts.TLSResolutionTest))
    suite.addTest(TestLoader().loadTestsFromTestCase(scripts.TLSLibcSymbolsTest))
    suite.addTest(TestLoader().loadTestsFromTestCase(scripts.TLSResolverAPITest))
    suite.addTest(TestLoader().loadTestsFromTestCase(scripts.TLSOffsetConsistencyTest))
    suite.addTest(TestLoader().loadTestsFromTestCase(scripts.TLSSymbolTest))
    suite.addTest(TestLoader().loadTestsFromTestCase(scripts.TLSAddressResolutionTest))
    suite.addTest(TestLoader().loadTestsFromTestCase(scripts.TLSSymbolSearchTest))
