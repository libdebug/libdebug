...
class ConfigurationMixin(EngineBoundMixin):
    ...
    @property
    def preserve_event_hooks_on_exec(self: ConfigurationMixin) -> bool:
    ...
    def preserve_event_hooks_on_exec(self: ConfigurationMixin, value: bool) -> None:
    ...
    @property
    def stop_on_fork(self: ConfigurationMixin) -> bool:
        """Get whether the debugger stops on fork."""
        return self._internal_debugger.stop_on_fork

    @stop_on_fork.setter
    def stop_on_fork(self: ConfigurationMixin, value: bool) -> None:
    ...
    @property
    def stop_on_exec(self: ConfigurationMixin) -> bool:
        """Get whether the debugger stops on exec."""
        return self._internal_debugger.stop_on_exec

    @stop_on_exec.setter
    def stop_on_exec(self: ConfigurationMixin, value: bool) -> None:
    ...
    @property
    def stop_on_clone(self: ConfigurationMixin) -> bool:
        """Get whether the debugger stops on clone."""
        return self._internal_debugger.stop_on_clone

    @stop_on_clone.setter
    def stop_on_clone(self: ConfigurationMixin, value: bool) -> None:
